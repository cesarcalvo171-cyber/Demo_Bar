          ...
          return (
            ...
            >
              ...
              <div className="p-3.5 flex flex-col flex-1 justify-between">
                <div>
                  <h4 className="font-semibold text-slate-100 text-[13px] leading-tight line-clamp-2">{product.name}</h4>
                  <div className="flex flex-wrap items-center gap-1.5 mt-2">
                    {hasStock ? (
                      <span className={`text-[9px] px-1.5 py-0.5 rounded font-bold ${
                        product.stock < 10 ? 'bg-orange-900/40 text-orange-400' : 'bg-slate-700 text-slate-300'
                      }`}>
                        Stock: {product.stock}
                      </span>
                    ) : (
